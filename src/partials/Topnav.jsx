...
export default function Topnav() {
    ...
    return (
        <div className='w-full h-[10vh] relative flex justify-start ml-[20%] items-center'>
            ...
            <div className={`w-[60%] max-h-[80vh] bg-[#1f1e24] absolute top-[90%] overflow-auto rounded  border-[#6556Cd] ` + (!query ? "" : "border-[0.1px] ")}>
                ...
                {searches?.length === 0 && query !== "" ?
                    ...
                    searches?.map((item, index) => {
                        return (
                            <Link
                                key={index}
                                className='p-10 w-full flex justify-start items-center border-b-2 border-zinc-100 text-zinc-200 font-semibold hover:bg-[#6556Cd] hover:text-[#1f1e24] duration-200' to="/">
