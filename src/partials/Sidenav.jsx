    ...
    return (
        <div className='w-[20%] h-full border-r-2 border-zink-200/90 p-10'>
            ...
            <nav className='flex flex-col text-zink-400 gap-2 text-white'>
                ...
                <Link className='hover:bg-[#6556Cd] p-5 text-lg hover:text-white rounded-lg duration-300' to="/"><i className="ri-fire-fill"></i> Trending</Link>
                <Link className='hover:bg-[#6556Cd] p-5 text-lg hover:text-white rounded-lg duration-300' to="/"><i className="mr-2 ri-sparkling-fill"></i>Popular</Link>
                <Link className='hover:bg-[#6556Cd] p-5 text-lg hover:text-white rounded-lg duration-300' to="/"><i className="mr-2 ri-movie-2-fill"></i>Movies</Link>
                <Link className='hover:bg-[#6556Cd] p-5 text-lg hover:text-white rounded-lg duration-300' to="/"><i className="mr-2 ri-tv-2-fill"></i>Tv Shows</Link>
